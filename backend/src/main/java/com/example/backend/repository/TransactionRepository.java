...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT t FROM Transaction t WHERE t.userId = :userId AND t.categoryId = :categoryId AND t.transactionDate BETWEEN :startDate AND :endDate")
    ...
    @Query("SELECT COUNT(t) FROM Transaction t WHERE t.userId = :userId AND t.isAuto = true")
