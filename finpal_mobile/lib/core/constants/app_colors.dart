...
class AppColors {
  ...
  static const Color primaryGradientStart = Color(0xFF155DFC);
  static const Color primaryGradientEnd = Color(0xFF155DFC);

  // Background Colors
  static const Color background = Color(0xFFF0F4FF); // Light blue background
  ...
  static const Color textPlaceholder = Color(0xFF717182);
