    ...
    try {
      ...
      if (mounted) {
        ...
        if (e is TimeoutException) {
          // Lỗi timeout - hiển thị dialog mất kết nối
          _showConnectionLostDialog();
        } else if (e is ApiException) {
          if (e.type == 'connection') {
            // Lỗi kết nối - hiển thị dialog mất kết nối
            _showConnectionLostDialog();
          } else {
            // Lỗi validation (sai thông tin, etc) - hiển thị SnackBar
          ...
          // Lỗi không xác định - hiển thị SnackBar
